...
const NFCCard = () => {
  return (
    <motion.div
      className="w-[340px] h-[200px] rounded-2xl shadow-2xl bg-gradient-to-br from-[#181e26] to-[#0c0e12] flex flex-col justify-between p-6 relative overflow-hidden"
    ...
    >
      ...
      <div className="flex justify-between items-start">
        <div>
          <div className="text-white text-lg font-semibold">Classic Black</div>
          <div className="text-gray-400 text-sm mt-1">Elegant & Professional</div>
        </div>
        {/* NFC sinyal ikonu */}
      ...
      <div className="flex justify-between items-end w-full mt-8">
        <div className="flex flex-col gap-1">
          <span className="text-gray-400 text-xs">contact@example.com</span>
          <span className="text-gray-500 text-xs">www.example.com</span>
        </div>
